...
if st.button("Analyze Stock"):
    ...
    elif trend == "WEEKLY UPTREND":

        st.success(trend)

    elif trend == "DAILY UPTREND":
    ...
    st.write(
        f"Setup Type : {trade_plan['setup_type']}"
    )

    st.write(
        f"Trade Quality : {trade_plan['trade_quality']}"
    )
